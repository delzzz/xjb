...
<body>
    ...
    <form action="<?php echo U('write');?>" method="post" class="form-horizontal">
        <div class="controls">
            ...
            <input type="hidden" name="picture_id" id="cover_id" value="<?php echo ((isset($info["picture_id"]) && ($info["picture_id"] !== ""))?($info["picture_id"]):''); ?>"/>
            <div class="upload-img-box">
                <?php if(!empty($info["picture_id"])): ?><div class="upload-pre-item"><img src="<?php echo get_cover($info['picture_id'])['path'];?>"/></div><?php endif; ?>
            </div>
        </div>
        <script type="text/javascript" src="/Public/static/jquery-2.0.3.min.js"></script>
        ...
        <div class="form-item">
            <label class="item-label">优先级<span class="check-tips">(页面显示顺序)</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="level" value="<?php echo ((isset($info["level"]) && ($info["level"] !== ""))?($info["level"]):0); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">url<span class="check-tips">(跳转链接)</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="url" value="<?php echo ((isset($info["url"]) && ($info["url"] !== ""))?($info["url"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">title<span class="check-tips">(勇于突破alt属性)</span></label>
            <div class="controls">
    ...
    <script type="text/javascript">
        highlight_subnav("<?php echo U('Banner/index');?>");
    </script>
