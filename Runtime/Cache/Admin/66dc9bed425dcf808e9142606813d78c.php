...
<body>
    ...
    <form id="form" action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="contact_person"
                       value="<?php echo ((isset($info["contact_person"]) && ($info["contact_person"] !== ""))?($info["contact_person"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">qq<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="qq" value="<?php echo ((isset($info["qq"]) && ($info["qq"] !== ""))?($info["qq"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">微信<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="wechat" value="<?php echo ((isset($info["wechat"]) && ($info["wechat"] !== ""))?($info["wechat"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">email<span class="check-tips"></span></label>
            <div class="controls">
    ...
    <script type="text/javascript">
        highlight_subnav("<?php echo U('About/index');?>");
    </script>
