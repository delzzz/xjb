...
<body>
    ...
    <form action="<?php echo U('write');?>" method="post" class="form-horizontal">
        <div class="controls">
            ...
            <input type="hidden" name="id" id="cover_id" value="<?php echo ((isset($info["id"]) && ($info["id"] !== ""))?($info["id"]):''); ?>"/>
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <select name="marks">
                    <?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$type): $mod = ($i % 2 );++$i;?><option value="<?php echo ($type["name"]); ?>" <?php echo ($info[ 'marks']==$type['name']?'selected':''); ?>><?php echo ($type["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <div class="form-item">
